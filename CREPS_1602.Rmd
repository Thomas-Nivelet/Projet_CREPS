...
(analyser les scores où il y a le plus de monde et comparer : variabilité des profils...)
...
```
(50% des observations sont rassemblées à l'intérieur d'une boîte)
...
En aviron, on observe un faible écart inter-qartiles, les scores ne sont pas trop dispersés au sein de ce pôle, niveau homogène. (mais 2 outliers).
En Natation Synchronisée, la médiane s'élève à 11/20, la plus élevée parmi tous les pôles. De plus, l'écart interquartiles n'est pas très haut, on peut en déduire un niveau homogène et bon.
...
Les seuls 0 visibles correspondent aux joueurs de Basket Ball, mais ils sont les plus nombreux (donc plus de possibilités de varibilité des scores).
En Natation synchronisée, les scores se situent entre 7 (élevé pour un score minimum) et 18/20.
Du fait qu'ils soient nombreux, on voit bien que les joueurs de basket ont des scores qui s'étendent de 0 à 19/20 (niveaux hétérogènes).
...
A Chercher : p-valeurs élevées (on ne rejette pas la nullité du paramètre) à interpréter (variables poles n'expliquent pas/mal les scores...?)
...
```
Alors que chaque pôle apparaît sur quasiment chaque score possible de mobilité inf, les athlètes de natation synchronisée n'apparaissent qu'à parti de 3/8 ! 
