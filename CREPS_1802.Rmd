...
De plus, pour le modèle de régression linéaire en fonction du score médian de chaque pôle, on peut remarquer que la p-valeur du test de comparaison avec le modèle blanc est faible. On peut donc rejeter avec assez de confiance le modèle blanc, ce qui confirme que ce modèle semble assez bien ajuster les données.

Pour le score moyen:

Visuellement, on pourrait également dire que la droite de régression linéaire semble ajuster les données. 

Cependant, la p-valeur du test de comparaison avec le modèle blanc est environ égale à 0.01, ce qui ne nous permet pas de rejeter avec grande confiance le modèle blanc. PAr conséquent le modèle de régression linéaire n'ajuste pas avec confiance les données?
...
coord_x=tab_median_mobinf[c(1:4,6:7)]
coord_y=donnees_bless$BLESS_POURC
nom=c("AV","BF","BK","BL","NAT","NS")
...
coord_x=tab_median_stabsup[c(1:4,6:7)]
coord_y=donnees_bless$BLESS_POURC
nom=c("AV","BF","BK","BL","NAT","NS")
...
coord_x=tab_median_mobsup[c(1:4,6:7)]
coord_y=donnees_bless$BLESS_POURC
nom=c("AV","BF","BK","BL","NAT","NS")
...
coord_x=tab_median_stabinf[c(1:4,6:7)]
coord_y=donnees_bless$BLESS_POURC
nom=c("AV","BF","BK","BL","NAT","NS")
...
coord_x=tab_mean_mobinf[c(1:4,6:7)]
coord_y=donnees_bless$BLESS_POURC
nom=c("AV","BF","BK","BL","NAT","NS")
...
coord_x=tab_mean_stabsup[c(1:4,6:7)]
coord_y=donnees_bless$BLESS_POURC
nom=c("AV","BF","BK","BL","NAT","NS")
...
coord_x=tab_mean_mobsup[c(1:4,6:7)]
coord_y=donnees_bless$BLESS_POURC
nom=c("AV","BF","BK","BL","NAT","NS")
...
coord_x=tab_mean_stabinf[c(1:4,6:7)]
coord_y=donnees_bless$BLESS_POURC
nom=c("AV","BF","BK","BL","NAT","NS")
...
Indispo_1 = c(max(donnees_indispo$NB_INDISPO_1),min(donnees_indispo$NB_INDISPO_1),mean(donnees_indispo$NB_INDISPO_1[POLE=="AV"]),mean(donnees_indispo$NB_INDISPO_1[POLE=="BF"]),mean(donnees_indispo$NB_INDISPO_1[POLE=="BK"]),mean(donnees_indispo$NB_INDISPO_1[POLE=="BL"]),mean(donnees_indispo$NB_INDISPO_1[POLE=="NAT"]),mean(donnees_indispo$NB_INDISPO_1[POLE=="NS"]))
 

Indispo_2 = c(max(donnees_indispo$NB_INDISPO_2),min(donnees_indispo$NB_INDISPO_2),mean(donnees_indispo$NB_INDISPO_2[POLE=="AV"]),mean(donnees_indispo$NB_INDISPO_2[POLE=="BF"]),mean(donnees_indispo$NB_INDISPO_2[POLE=="BK"]),mean(donnees_indispo$NB_INDISPO_2[POLE=="BL"]),mean(donnees_indispo$NB_INDISPO_2[POLE=="NAT"]),mean(donnees_indispo$NB_INDISPO_2[POLE=="NS"]))
 

Indispo_3 = c(max(donnees_indispo$NB_INDISPO_3),min(donnees_indispo$NB_INDISPO_3),mean(donnees_indispo$NB_INDISPO_3[POLE=="AV"]),mean(donnees_indispo$NB_INDISPO_3[POLE=="BF"]),mean(donnees_indispo$NB_INDISPO_3[POLE=="BK"]),mean(donnees_indispo$NB_INDISPO_3[POLE=="BL"]),mean(donnees_indispo$NB_INDISPO_3[POLE=="NAT"]),mean(donnees_indispo$NB_INDISPO_3[POLE=="NS"]))
...
```{r}
Moy_ind_1= c(mean(donnees_indispo$NB_INDISPO_1[POLE=="AV"]),mean(donnees_indispo$NB_INDISPO_1[POLE=="BF"]),mean(donnees_indispo$NB_INDISPO_1[POLE=="BK"]), mean(donnees_indispo$NB_INDISPO_1[POLE=="BL"]), mean(donnees_indispo$NB_INDISPO_1[POLE=="NAT"]), mean(donnees_indispo$NB_INDISPO_1[POLE=="NS"]))
print(Moy_ind_1)

Moy_ind_2= c(mean(donnees_indispo$NB_INDISPO_2[POLE=="AV"]),mean(donnees_indispo$NB_INDISPO_2[POLE=="BF"]),mean(donnees_indispo$NB_INDISPO_2[POLE=="BK"]), mean(donnees_indispo$NB_INDISPO_2[POLE=="BL"]), mean(donnees_indispo$NB_INDISPO_2[POLE=="NAT"]), mean(donnees_indispo$NB_INDISPO_2[POLE=="NS"]))
print(Moy_ind_2)

Moy_ind_3= c(mean(donnees_indispo$NB_INDISPO_3[POLE=="AV"]),mean(donnees_indispo$NB_INDISPO_3[POLE=="BF"]),mean(donnees_indispo$NB_INDISPO_3[POLE=="BK"]), mean(donnees_indispo$NB_INDISPO_3[POLE=="BL"]), mean(donnees_indispo$NB_INDISPO_3[POLE=="NAT"]), mean(donnees_indispo$NB_INDISPO_3[POLE=="NS"]))
print(Moy_ind_3)
...
y=matrix(data=c(ordonnee_AV, ordonnee_BF, ordonnee_BK, ordonnee_BL, ordonnee_NAT, ordonnee_NS), nrow = 3, ncol = 6)
