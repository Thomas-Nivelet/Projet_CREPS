...
plot(coord_x,coord_y, ylab="Injured percentage", xlab="Median Score for each pole", main="Injured percentage VS median score for each pole", cex.main=0.7)
...
plot(coord_x,coord_y,  ylab="Injured percentage", xlab="Average score for each pole", main="Injured percentage VS average score for each pole", cex.main=0.7)
...
#par(mar=c(5,5,2,2))
matplot(x,y,type="l", ylim=range(y), col=c("black","red", "green3","blue","cyan","magenta", "yellow","gray"), lty=1:3, xaxt="n", ylab="Mean of Injuries", xlab="Unavailability category", main="Number of injuries mean VS Unavailability category per athlete, for each pole", cex.main=0.8)
legend('topright',legend = c("RW", "FB", "BK", "BL", "BS", "S", "SS", "R"), col = c("black","red", "green3","blue","cyan","magenta", "yellow","gray"), lty = 1:3, lwd = 1 )
xtick=seq(1,3, by=1)
axis(side=1, at=xtick, labels=c("Unavailab 1", "Unavailab 2", "Unavailab 3"))
```
