...
On constate que les notes sont très échelonnées de 0 à 19 et prennent quasiment la totalité des valeurs possibles. Le score le plus obtenu au test est la note de 10, soit la moyenne. L'allure globale du bar plot fait furieusement penser à une courbe gaussienne, avec donc un certain étalement sur 20 valeurs ainsi qu'une légère symétrie.
