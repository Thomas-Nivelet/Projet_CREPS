...
#par(new=T)
plot(donnees_creps$SCORE ~donnees_creps$Contact, main="Comparison between Score and casualties percentage by pole type", cex.main=0.75, ylab="", xlab="", axes = FALSE,col="blue")
